"""
╔══════════════════════════════════════════════════════════════════════╗
║        BINARY NEURAL NETWORKS — СРАВНИТЕЛЬНЫЙ ЭКСПЕРИМЕНТ           ║
║                 PyTorch | MNIST | Воспроизводимый                    ║
╚══════════════════════════════════════════════════════════════════════╝

ЗАПУСК В GOOGLE COLAB — пошаговая инструкция:
═══════════════════════════════════════════════
...
Все графики сохранятся в папку ./plots/ и отобразятся прямо в Colab.
Полное время обучения: ~5 мин (CPU) / ~2 мин (GPU).
